This a repo of the root folder of this project
...
The 101-clean_emacs file : is a shell script that deletes all files in the current working directory that end with the character ~.
